...
* Применена Flexbox вёрстка
* Анимации и трансформации созданы при помощи CSS
* В тегах iframe прикреплены видео при помощи API YouTube
* Использованы различные виды позиционирования
