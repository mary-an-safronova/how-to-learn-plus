...
Учебный проект 1-го спринта курса "Веб-разработчик плюс" Яндекс.Практикум
___________________________

## Описание

Проект представляет собой одностраничный сайт о техниках, принципах и методах обучения.
___________________________
...
<ui>
  <li>Файловая структура проекта организована по методологии БЭМ</li>
  <li>Применена Flexbox вёрстка</li>
  <li>Анимации и трансформации созданы при помощи CSS</li>
  <li>В тегах iframe прикреплены видео при помощи API YouTube</li>
  <li>Использованы различные виды позиционирования</li>
  <li>Применена стилизация на основе действий пользователя</li>
</ul>
